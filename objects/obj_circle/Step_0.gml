...
else
{
	...
	if (delay > 1 && mouse_check_button_pressed(mb_left))
	{
		depth = 0;
		var inst;
		inst = collision_rectangle(holeX-10, holeY-10, holeX+10, holeY+10, obj_circle, false, false);
		if inst != noone
		{
			x = holeX;
			y = holeY;
