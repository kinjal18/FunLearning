...
else
{
	...
	if (delay > 1 && mouse_check_button_pressed(mb_left))
	{
		depth = 0;
		var inst;
		inst = collision_rectangle(holeX-5, holeY-5, holeX+5, holeY+5, obj_diamond, false, false);
		if inst != noone
		{
			x = holeX;
			y = holeY;
